...
{
    private IUAVariable Refresh;
    public override void Start()
	{
        Refresh = Owner.GetVariable("Refresh");
        Refresh.VariableChange += Refresh_VariableChange;
    ...
    private void Refresh_VariableChange(object sender, VariableChangeEventArgs e)
    {
        pathVariable = LogicObject.GetVariable("Path");
        Browse(new ResourceUri(pathVariable.Value).AbsoluteFilePath);
        Refresh.Value = false;
    }
